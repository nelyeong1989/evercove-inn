...
<!-- Centered Viewport-Fitting Receipt Wrapper -->
<div class="receipt-page-wrap">
  <div class="receipt-box">
    <span class="eyebrow eyebrow-green">Reservation Confirmed</span>
    <h2 style="color: var(--emerald-green);">We'll have the fire ready.</h2>
    <p>Thank you, <?= htmlspecialchars($booking['guest_name']) ?>. Here is your reservation receipt:</p>
    ...
    <table class="receipt-table">
      ...
      <tr>
        ...
        <td><code style="font-size: 0.85rem; color: var(--emerald-green);"><?= htmlspecialchars($booking['payment_ref']) ?></code></td>
      </tr>
      <?php endif; ?>
      <tr>
      ...
      <tr>
        <th>Receipt Proof</th>
        <td>
          <a href="<?= htmlspecialchars($booking['payment_proof']) ?>" target="_blank" style="color: var(--gold-dark); text-decoration: underline; font-size: 0.82rem; font-weight: 700;">
    ...
    <div class="user-badge" style="justify-content: center; flex-wrap: wrap; gap: 0.6rem;">
      <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
        <a href="admin.php" class="btn btn-green btn-sm">&larr; Back to Management Console</a>
      <?php else: ?>
        <a href="my-bookings.php" class="btn btn-gold btn-sm">View My Bookings</a>
        <a href="index.php" class="btn btn-green btn-sm">Return to Home</a>
      <?php endif; ?>

      <button type="button" onclick="window.print()" class="btn btn-sage btn-sm">Print Receipt</button>
    </div>
  </div>
</div>
